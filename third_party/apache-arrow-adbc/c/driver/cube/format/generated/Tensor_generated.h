...
struct TensorDim FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_size(int64_t _size = 0) {
    return SetField<int64_t>(VT_SIZE, _size, 0);
  }
...
inline Tensor *GetMutableTensor(void *buf) {
  return flatbuffers::GetMutableRoot<Tensor>(buf);
}

inline org::apache::arrow::flatbuf::Tensor *GetMutableSizePrefixedTensor(void *buf) {
  return flatbuffers::GetMutableSizePrefixedRoot<org::apache::arrow::flatbuf::Tensor>(buf);
}
