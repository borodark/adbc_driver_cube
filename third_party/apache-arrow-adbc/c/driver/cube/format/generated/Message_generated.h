...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(8) FieldNode FLATBUFFERS_FINAL_CLASS {
 ...
 public:
  ...
  void mutate_null_count(int64_t _null_count) {
    flatbuffers::WriteScalar(&null_count_, _null_count);
  }
};
...
struct BodyCompression FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_codec(org::apache::arrow::flatbuf::CompressionType _codec = static_cast<org::apache::arrow::flatbuf::CompressionType>(0)) {
    return SetField<int8_t>(VT_CODEC, static_cast<int8_t>(_codec), 0);
  }
  ...
  bool mutate_method(org::apache::arrow::flatbuf::BodyCompressionMethod _method = static_cast<org::apache::arrow::flatbuf::BodyCompressionMethod>(0)) {
...
struct RecordBatch FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_length(int64_t _length = 0) {
    return SetField<int64_t>(VT_LENGTH, _length, 0);
  }
  ...
  flatbuffers::Vector<const org::apache::arrow::flatbuf::FieldNode *> *mutable_nodes() {
    return GetPointer<flatbuffers::Vector<const org::apache::arrow::flatbuf::FieldNode *> *>(VT_NODES);
  }
  ...
  flatbuffers::Vector<const org::apache::arrow::flatbuf::Buffer *> *mutable_buffers() {
    return GetPointer<flatbuffers::Vector<const org::apache::arrow::flatbuf::Buffer *> *>(VT_BUFFERS);
  }
  ...
  org::apache::arrow::flatbuf::BodyCompression *mutable_compression() {
    return GetPointer<org::apache::arrow::flatbuf::BodyCompression *>(VT_COMPRESSION);
  }
  ...
  flatbuffers::Vector<int64_t> *mutable_variadicBufferCounts() {
    return GetPointer<flatbuffers::Vector<int64_t> *>(VT_VARIADICBUFFERCOUNTS);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct DictionaryBatch FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  org::apache::arrow::flatbuf::RecordBatch *mutable_data() {
    return GetPointer<org::apache::arrow::flatbuf::RecordBatch *>(VT_DATA);
  }
  ...
  bool mutate_isDelta(bool _isDelta = 0) {
    return SetField<uint8_t>(VT_ISDELTA, static_cast<uint8_t>(_isDelta), 0);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct Message FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_version(org::apache::arrow::flatbuf::MetadataVersion _version = static_cast<org::apache::arrow::flatbuf::MetadataVersion>(0)) {
    return SetField<int16_t>(VT_VERSION, static_cast<int16_t>(_version), 0);
  }
  ...
  void *mutable_header() {
    return GetPointer<void *>(VT_HEADER);
  }
  int64_t bodyLength() const {
    return GetField<int64_t>(VT_BODYLENGTH, 0);
  }
  bool mutate_bodyLength(int64_t _bodyLength = 0) {
    return SetField<int64_t>(VT_BODYLENGTH, _bodyLength, 0);
  }
...
inline void RecordBatch::UnPackTo(RecordBatchT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = buffers(); if (_e) { _o->buffers.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->buffers[_i] = *_e->Get(_i); } } }
  { auto _e = compression(); if (_e) _o->compression = std::unique_ptr<org::apache::arrow::flatbuf::BodyCompressionT>(_e->UnPack(_resolver)); }
  { auto _e = variadicBufferCounts(); if (_e) { _o->variadicBufferCounts.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->variadicBufferCounts[_i] = _e->Get(_i); } } }
}
...
inline void DictionaryBatch::UnPackTo(DictionaryBatchT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  (void)_resolver;
  { auto _e = id(); _o->id = _e; }
  { auto _e = data(); if (_e) _o->data = std::unique_ptr<org::apache::arrow::flatbuf::RecordBatchT>(_e->UnPack(_resolver)); }
...
inline org::apache::arrow::flatbuf::Message *GetMutableSizePrefixedMessage(void *buf) {
  return flatbuffers::GetMutableSizePrefixedRoot<org::apache::arrow::flatbuf::Message>(buf);
}
