...
struct SparseTensorIndexCOO FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  org::apache::arrow::flatbuf::Int *mutable_indicesType() {
    return GetPointer<org::apache::arrow::flatbuf::Int *>(VT_INDICESTYPE);
  }
  ...
  flatbuffers::Vector<int64_t> *mutable_indicesStrides() {
    return GetPointer<flatbuffers::Vector<int64_t> *>(VT_INDICESSTRIDES);
  }
  ...
  org::apache::arrow::flatbuf::Buffer *mutable_indicesBuffer() {
    return GetStruct<org::apache::arrow::flatbuf::Buffer *>(VT_INDICESBUFFER);
  }
  ...
  bool mutate_isCanonical(bool _isCanonical = 0) {
    return SetField<uint8_t>(VT_ISCANONICAL, static_cast<uint8_t>(_isCanonical), 0);
  }
...
struct SparseMatrixIndexCSX FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_compressedAxis(org::apache::arrow::flatbuf::SparseMatrixCompressedAxis _compressedAxis = static_cast<org::apache::arrow::flatbuf::SparseMatrixCompressedAxis>(0)) {
    return SetField<int16_t>(VT_COMPRESSEDAXIS, static_cast<int16_t>(_compressedAxis), 0);
  }
  ...
  org::apache::arrow::flatbuf::Int *mutable_indptrType() {
    return GetPointer<org::apache::arrow::flatbuf::Int *>(VT_INDPTRTYPE);
  }
  ...
  org::apache::arrow::flatbuf::Buffer *mutable_indptrBuffer() {
    return GetStruct<org::apache::arrow::flatbuf::Buffer *>(VT_INDPTRBUFFER);
  }
  /// The type of values in indicesBuffer
  const org::apache::arrow::flatbuf::Int *indicesType() const {
    return GetPointer<const org::apache::arrow::flatbuf::Int *>(VT_INDICESTYPE);
...
struct SparseTensorIndexCSF FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  flatbuffers::Vector<const org::apache::arrow::flatbuf::Buffer *> *mutable_indptrBuffers() {
    return GetPointer<flatbuffers::Vector<const org::apache::arrow::flatbuf::Buffer *> *>(VT_INDPTRBUFFERS);
  }
  ...
  flatbuffers::Vector<const org::apache::arrow::flatbuf::Buffer *> *mutable_indicesBuffers() {
    return GetPointer<flatbuffers::Vector<const org::apache::arrow::flatbuf::Buffer *> *>(VT_INDICESBUFFERS);
  }
  ...
  flatbuffers::Vector<int32_t> *mutable_axisOrder() {
    return GetPointer<flatbuffers::Vector<int32_t> *>(VT_AXISORDER);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffsetRequired(verifier, VT_INDPTRTYPE) &&
...
struct SparseTensor FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  flatbuffers::Vector<flatbuffers::Offset<org::apache::arrow::flatbuf::TensorDim>> *mutable_shape() {
    return GetPointer<flatbuffers::Vector<flatbuffers::Offset<org::apache::arrow::flatbuf::TensorDim>> *>(VT_SHAPE);
  }
  /// The number of non-zero values in a sparse tensor.
  int64_t non_zero_length() const {
    return GetField<int64_t>(VT_NON_ZERO_LENGTH, 0);
  }
  bool mutate_non_zero_length(int64_t _non_zero_length = 0) {
    return SetField<int64_t>(VT_NON_ZERO_LENGTH, _non_zero_length, 0);
  }
  ...
  void *mutable_sparseIndex() {
    return GetPointer<void *>(VT_SPARSEINDEX);
  }
  /// The location and size of the tensor's data
  const org::apache::arrow::flatbuf::Buffer *data() const {
    return GetStruct<const org::apache::arrow::flatbuf::Buffer *>(VT_DATA);
  }
  org::apache::arrow::flatbuf::Buffer *mutable_data() {
    return GetStruct<org::apache::arrow::flatbuf::Buffer *>(VT_DATA);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
inline void SparseTensorIndexCOO::UnPackTo(SparseTensorIndexCOOT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = indicesType(); if (_e) _o->indicesType = std::unique_ptr<org::apache::arrow::flatbuf::IntT>(_e->UnPack(_resolver)); }
  { auto _e = indicesStrides(); if (_e) { _o->indicesStrides.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->indicesStrides[_i] = _e->Get(_i); } } }
...
inline void SparseMatrixIndexCSX::UnPackTo(SparseMatrixIndexCSXT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = indptrType(); if (_e) _o->indptrType = std::unique_ptr<org::apache::arrow::flatbuf::IntT>(_e->UnPack(_resolver)); }
...
inline void SparseTensorIndexCSF::UnPackTo(SparseTensorIndexCSFT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  (void)_resolver;
  { auto _e = indptrType(); if (_e) _o->indptrType = std::unique_ptr<org::apache::arrow::flatbuf::IntT>(_e->UnPack(_resolver)); }
  { auto _e = indptrBuffers(); if (_e) { _o->indptrBuffers.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->indptrBuffers[_i] = *_e->Get(_i); } } }
  { auto _e = indicesType(); if (_e) _o->indicesType = std::unique_ptr<org::apache::arrow::flatbuf::IntT>(_e->UnPack(_resolver)); }
  { auto _e = indicesBuffers(); if (_e) { _o->indicesBuffers.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->indicesBuffers[_i] = *_e->Get(_i); } } }
  { auto _e = axisOrder(); if (_e) { _o->axisOrder.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->axisOrder[_i] = _e->Get(_i); } } }
}
...
inline void SparseTensor::UnPackTo(SparseTensorT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = shape(); if (_e) { _o->shape.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->shape[_i] = std::unique_ptr<org::apache::arrow::flatbuf::TensorDimT>(_e->Get(_i)->UnPack(_resolver)); } } }
...
inline SparseTensor *GetMutableSparseTensor(void *buf) {
  return flatbuffers::GetMutableRoot<SparseTensor>(buf);
}

inline org::apache::arrow::flatbuf::SparseTensor *GetMutableSizePrefixedSparseTensor(void *buf) {
  return flatbuffers::GetMutableSizePrefixedRoot<org::apache::arrow::flatbuf::SparseTensor>(buf);
}
